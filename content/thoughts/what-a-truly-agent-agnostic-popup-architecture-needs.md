...
summary: The concrete architecture needed to make Beacon and Loki lifecycle-driven instead of Claude-driven, with a clear split between adapters, control plane, and clients.
...
If that holds, the popup belongs to Loki.
