---
title: Projects Are the Unit of Execution
summary: Why Projects are not just records in a database, but the basic execution unit that connects repos, prompts, goals, and agent state.
excerpt: In Cockpit, the project is the container where code, context, runtime state, and strategic direction meet.
...
---
## Why Projects Matter
Projects are the unit of execution in Cockpit.
...
Cockpit should do the opposite. A project should be the place where context becomes operational:
