...
The third is **a machine you own that is always on** — a cheap VPS, a home server, a box in a rack. Not a clean-room clone: your real environment, your other repos, your local services, your credentials, persistent between runs. This is the one [the levelsio pattern](/thoughts/the-levelsio-pattern-productized-who-loki-is-for) describes people already building by hand, and the one [The Captain Needs a Ship](/thoughts/the-captain-needs-a-ship) argued Loki had to be able to run on for its users, not just its founder.
