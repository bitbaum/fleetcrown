...
summary: A case for adding image upload and paste support to Loki's agent interface, and what it would take to do it right.
...
The current agent interface in Loki accepts text. Prompts, queue items, custom instructions — all text.
...
## What "Image Input" Would Look Like in Loki
...
This is the Loki way: ship the minimal version, measure real impact, then build what the data justifies.
