...
context, prioritization, and trust. Loki owns that layer: the durable
...
1. **Personal Pro**
   - For one builder using Loki as daily operating layer.
...
- **Project count expansion**: more tracked projects increase switching cost
  outside Loki and make the unified control plane more valuable.
...
- **Agent neutrality**: Loki is positioned above individual model vendors and
  CLIs.
