    ...
    >
      ...
      {showAwaitingUser && (
        <span
          ...
          title={`Agent is waiting on you. Last reported next step: "${project.session?.next ?? "(none)"}". Open the project's session handoff or check ~/.loki/sessions/${project.tab}.blockers/pending/ for the blocker file.`}
        >
          Needs input
        </span>
      )}
