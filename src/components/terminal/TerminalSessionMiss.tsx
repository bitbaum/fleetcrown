  ...
  return (
    <div className="ui-term-miss">
      ...
      <p className="ui-term-miss-body">
        Nothing is attached yet. If you just clicked Implement, the cloud builder
        cold-starts a session when it is online — until then Control says Connect
        a builder. Pick another running session only if you mean to type there.
      </p>
