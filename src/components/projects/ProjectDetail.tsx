...
import {
  X, Globe, GitBranch, AlertTriangle, Loader2,
} from "lucide-react";
...
export function ProjectDetail({
  ...
  const prodUrl = attrs[LINK_ATTRS[0]] ?? attrs[LINK_ATTRS[3]];   // production_url ?? url
  const repo    = attrs[LINK_ATTRS[1]] ?? attrs[LINK_ATTRS[2]];   // repo ?? github_repo
