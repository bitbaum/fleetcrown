 ...
 */
const globalForDb = globalThis as unknown as { __lokiPg?: ReturnType<typeof postgres> };
const client = globalForDb.__lokiPg ?? postgres(DATABASE_URL, { max: 5 });
if (process.env.NODE_ENV !== "production") globalForDb.__lokiPg = client;
