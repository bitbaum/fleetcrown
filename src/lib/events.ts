...
/**
 * Session-handoff fields the agent writes to ~/.loki/sessions/<tab>.md.
 *
...
export const FAILING_OUTCOMES: ReadonlySet<string> = new Set(
  // `unconfirmed` is here deliberately, and it is the uncomfortable one. The
  ...
  ["error", "hang", "timeout", "unconfirmed"] as const satisfies readonly Outcome[],
);
