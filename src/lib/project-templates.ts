...
> Generated by [Loki](${APP_URL}/) — the captain-mode command center for your AI agent fleet.
...
- Need a backend? Use the **Hono + Cloudflare Workers** Loki template alongside this for the API.
`;
