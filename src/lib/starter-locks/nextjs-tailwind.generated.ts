...
// The nextjs-tailwind starter's package.json, resolved once with
...
export const NEXTJS_TAILWIND_PNPM_LOCK = `lockfileVersion: '9.0'
...
importers:
  ...
  .:
    dependencies:
      next:
        specifier: 16.3.4
        version: 16.3.4(@types/node@20.19.43)(react-dom@19.3.0(react@19.3.0))(react@19.3.0)
      react:
        specifier: ^19.0.0
        version: 19.3.0
      react-dom:
...
snapshots:
  ...
  next@16.3.4(@types/node@20.19.43)(react-dom@19.3.0(react@19.3.0))(react@19.3.0):
    dependencies:
      '@next/env': 16.3.4
      '@swc/helpers': 0.5.23
      baseline-browser-mapping: 2.11.21
