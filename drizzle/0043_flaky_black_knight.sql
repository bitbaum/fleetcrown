...
UPDATE "site_feedback" SET "source" = 'ai_review' WHERE "source" IS NULL AND "contact" = 'Loki AI reviewer';--> statement-breakpoint
UPDATE "site_feedback" SET "source" = 'synthesizer' WHERE "source" IS NULL AND "contact" = 'Loki synthesizer';--> statement-breakpoint
