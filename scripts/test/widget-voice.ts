...
// ---- mergeTranscript ----
ok(mergeTranscript("", "hello there", MAX) === "hello there", "empty box takes the transcript as-is");
ok(
...
ok(
  mergeTranscript("", "  padded  ", MAX) === "padded",
  "the incoming transcript is trimmed",
);
