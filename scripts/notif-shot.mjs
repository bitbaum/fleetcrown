...
await page.goto("http://localhost:3000/settings#notifications", { waitUntil: "load" });
await page.waitForTimeout(2000);
await page.screenshot({ path: path.join(outDir, "settings-notifications.png"), fullPage: false });
await browser.close();
