...
# (The former shiki top-level link is gone: bip-kit 0.2.1's setHighlighterLoader
# seam makes shiki a normal bundled dependency — nothing for the tracer to miss.)
