...
declare -A SCHED=( [prune-debug-logs]="03:00" [nudge-idle]="04:00" [prune-agent-tokens]="05:00" [email-canary]="06:00" [send-digest-emails]="07:00" [frontier-digest]="08:00" [orangecat-promote-backfill]="09:00" [reap-stale-runs]="*:15" )
...
for name in prune-debug-logs nudge-idle prune-agent-tokens email-canary send-digest-emails frontier-digest orangecat-promote-backfill reap-stale-runs; do
