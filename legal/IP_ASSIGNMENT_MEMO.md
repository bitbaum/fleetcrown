...
- **FleetCrown** — repository at `github.com/catomean/cockpit` (private; "cockpit" is the legacy repository directory name preserved for git history and in-flight daemon paths under `~/.config/cockpit`. The product is FleetCrown.)
- **OrangeCat** — repository at `github.com/catomean/orangecat`
